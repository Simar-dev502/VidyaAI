...
const formulaData = {
  "6": {
    ...
    "Basic Geometry": [
      ...
      { name: "Area of Triangle", formula: "A = ½ × base × height", desc: "" },
      { name: "Circumference of Circle", formula: "C = 2pr", desc: "p ˜ 3.14 or 22/7" },
  ...
  "7": {
    ...
    "Perimeter & Area": [
      ...
      { name: "Area of Triangle", formula: "A = ½ × b × h", desc: "" },
      { name: "Area of Parallelogram", formula: "A = base × height", desc: "" },
      { name: "Area of Rhombus", formula: "A = ½ × d1 × d2", desc: "d1, d2 = diagonals" },
    ],
    "Data Handling": [
  ...
  "8": {
    ...
    "Mensuration": [
      { name: "Area of Trapezium", formula: "A = ½ × (a + b) × h", desc: "a, b = parallel sides, h = height" },
      { name: "Area of Rhombus", formula: "A = ½ × d1 × d2", desc: "" },
  ...
  "9": {
    ...
    "Statistics": [
      { name: "Mean", formula: "x¯ = Sx / n", desc: "Sum of all values / count" },
  ...
  "10": {
    "Algebra": [
      ...
      { name: "Sum of Roots", formula: "a + ß = -b/a", desc: "" },
      { name: "Product of Roots", formula: "a × ß = c/a", desc: "" },
      ...
      { name: "GP nth Term", formula: "a? = a × rn?¹", desc: "r = common ratio" },
    ...
    "Coordinate Geometry": [
      ...
      { name: "Area of Triangle", formula: "A = ½|x1(y2-y3) + x2(y3-y1) + x3(y1-y2)|", desc: "" },
    ...
    "Statistics": [
      { name: "Mean (Direct)", formula: "x¯ = Sf?x? / Sf?", desc: "" },
      { name: "Mean (Assumed Mean)", formula: "x¯ = a + (Sf?d? / Sf?)", desc: "d = x - a" },
      { name: "Mean (Step Deviation)", formula: "x¯ = a + h × (Sf?u? / Sf?)", desc: "u = (x-a)/h" },
  ...
  "11": {
    ...
    "Sequences & Series": [
      ...
      { name: "AP Sum", formula: "S? = n/2[2a + (n-1)d]", desc: "" },
      { name: "GP nth Term", formula: "a? = arn?¹", desc: "" },
    ...
    "Statistics": [
      { name: "Variance", formula: "s² = S(x? - x¯)² / n", desc: "" },
      { name: "Standard Deviation", formula: "s = v[S(x? - x¯)² / n]", desc: "" },
      { name: "Coefficient of Variation", formula: "CV = (s / x¯) × 100", desc: "%" },
    ],
  },
  "12": {
    "Calculus — Derivatives": [
      { name: "First Principle", formula: "f'(x) = lim[h?0] (f(x+h)-f(x))/h", desc: "" },
      { name: "d/dx (xn)", formula: "nxn?¹", desc: "Power rule" },
      ...
      { name: "d/dx (sin?¹x)", formula: "1/v(1-x²)", desc: "" },
      { name: "d/dx (cos?¹x)", formula: "-1/v(1-x²)", desc: "" },
      { name: "d/dx (tan?¹x)", formula: "1/(1+x²)", desc: "" },
    ...
    "Calculus — Integrals": [
      { name: "?xn dx", formula: "xn?¹/(n+1) + C", desc: "n ? -1" },
      ...
      { name: "?1/(1+x²) dx", formula: "tan?¹x + C", desc: "" },
      { name: "?1/v(1-x²) dx", formula: "sin?¹x + C", desc: "" },
    ...
    "Matrices & Determinants": [
      ...
      { name: "Inverse", formula: "A?¹ = adj(A) / |A|", desc: "|A| ? 0" },
    ...
    "Vectors": [
      ...
      { name: "Unit Vector", formula: "â = a?/|a?|", desc: "" },
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-1">Complete CBSE formulas for Classes 6–12</p>
      </div>
      ...
      {/* -- SQUARES TABLE -- */}
      {activeTab === "squares" && (
        <DataTable title="Squares, Cubes & Square Roots (1–20)" icon="??"
      ...
      <div className="text-center mt-6 text-sm text-gray-400">
        ?? Hover over any formula card to copy it • Use tabs to view tables
      </div>
    </div>
  );
}
